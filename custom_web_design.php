            ...
            <div class="row">
              ...
              <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                <div class="development__img">
                  <img src="assets/images/banner-1.png" alt="Development Image" data-speed="auto">
                </div>
              </div>
              <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                <div class="development__img">
                  <img src="assets/images/banner-2.png" alt="Development Image">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9">
                <div class="service__detail-img">
                  <img src="assets/images/service-detail.png" alt="Service detail image">
                  <img src="assets/images/icon/shape-6.png" alt="Service shape image" class="sd-shape">
                </div>
          ...
          <div class="container g-0 line pb-140">
            ...
            <div class="row">
              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="faq__img">
                  <img src="assets/images/faq.jpg" alt="FAQ Image" data-speed="auto">
                </div>
              </div>
              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
